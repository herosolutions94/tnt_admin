...
@section('page_content')
                ...
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center">
                                        <div class="file_choose_icon">
                                            <img src="{{ get_site_image_src('coaches', !empty($row) ? $row->image : '') }}"
                                                alt="coach-img" class="img-fluid" width="120" height="120">
                                        </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100 border position-relative overflow-hidden">
                                <div class="card-body p-4">
                                    <h4 class="card-title">Coach Details</h4>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch py-2">
                                            ...
                                            <label class="form-check-label" for="color-success">
                                                {{ !empty($row) ? ($row->status == 0 ? 'InActive' : 'Active') : 'Status' }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 border position-relative overflow-hidden">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-3">
                                        <textarea class="form-control" name="description" rows="5">{{ !empty($row->description) ? $row->description : '' }}</textarea>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-flex align-items-center justify-content-end mt-4 gap-6">
                                            <a href="{{ url('admin/coaches') }}" class="btn btn-secondary">Cancel</a>
    ...
    @else
        {!! breadcrumb('Page Content Coaches', url('admin/coaches/add')) !!}
        <div class="card">
            <div class="card-body">
                <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-6 crud_thumbnail_icon">
                                                    <img src="{{ get_site_image_src('coaches', !empty($row->image) ? $row->image : '') }}"
                                                        width="60" />
                                                </div>
                                            </td>
                                            <td>{{ $row->name }}</td>
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/coaches/edit/' . $row->id) }}">
                                                                <i class="fs-4 ti ti-edit"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/coaches/delete/' . $row->id) }}"
