...
@section('page_content')
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center">
                                        <div class="file_choose_icon">
                                            <img src="{{ get_site_image_src('interns', !empty($row) ? $row->image : '') }}"
                                                alt="intern-img" class="img-fluid" width="120" height="120">
                                        </div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="time_period"
                                            ...
                                            value="{{ !empty($row->time_period) ? $row->time_period : '' }}">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-center justify-content-end mt-4 gap-6">
                                            <a href="{{ url('admin/interns') }}" class="btn btn-secondary">Cancel</a>
    ...
    @else
        {!! breadcrumb('Our Interns', url('admin/interns/add')) !!}
        <div class="card">
            <div class="card-body">
                <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-6 crud_thumbnail_icon">
                                                    <img src="{{ get_site_image_src('interns', !empty($row->image) ? $row->image : '') }}"
                                                        width="60" />
                                                </div>
                                            </td>
                                            <td>{{ $row->name }}</td>
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/interns/edit/' . $row->id) }}">
                                                                <i class="fs-4 ti ti-edit"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/interns/delete/' . $row->id) }}"
