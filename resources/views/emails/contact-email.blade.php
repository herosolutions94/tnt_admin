                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    User Type: <b>{{ $content['mem_data']['user_type'] }}</b>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Phone No: <b>{{ $content['mem_data']['phone'] }}</b>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Work Type: <b>{{ $content['mem_data']['work_type'] }}</b>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Specialization: <b>{{ $content['mem_data']['specialization'] }}</b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Location: <b>{{ $content['mem_data']['office'] }}</b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
